...
def init_discord_bot():
    ...
    async def on_message(message):
        ...
        if str(message.content) != ".crawlnreact" or str(message.author) != presets.OWNER_TAG:
            return
        ...
        async for cur_message in message.channel.history(limit=None, oldest_first=False):
            print('='*50)
